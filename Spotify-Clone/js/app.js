...
const trendingSongRow = document.getElementById("trendingSongRow");
...
async function fetchMusic() {
  try {
    trendingSongRow.innerHTML = "<p>Loading songs...</p>";

    artistRow.innerHTML = "<p>Loading artists...</p>";

    albumRow.innerHTML = "<p>Loading albums...</p>";
    ...
    trendingSongRow.innerHTML = "<p>Unable to load songs.</p>";

    artistRow.innerHTML = "<p>Unable to load artists.</p>";

    albumRow.innerHTML = "<p>Unable to load albums.</p>";
  }
}
...
function renderSongs() {
  ...
  songs.slice(0, 10).forEach(function (song, index) {
    ...
    trendingSongRow.appendChild(card);
  });
}
...
function renderArtists() {
  ...
  songs.forEach(function (song) {
    const exists = artists.some(function (artist) {
  ...
  artists.slice(0, 10).forEach(function (artist) {
    const card = document.createElement("article");
...
function renderAlbums() {
  ...
  songs.forEach(function (song) {
    ...
    const exists = albums.some(function (album) {
      return album.name === song.album_name;
    });
  ...
  albums.slice(0, 10).forEach(function (album) {
    const card = document.createElement("article");
